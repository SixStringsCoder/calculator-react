      ...
      <main id="calc-body">
        ...
        <section id="calc-btn-section">
          ...
          <button onClick={this.enterEquation}
                  class="black-btn" id="div-sign" value="/">&#247;</button>
          <button onClick={this.enterEquation}
                  class="black-btn" id="x-sign" value="*">&#215;</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="7" value="7">7</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="8" value="8">8</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="9" value="9">9</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="minus" value="-">&#8722;</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="4" value="4">4</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="5" value="5">5</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="6" value="6">6</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="plus" value="+">&#43;</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="1" value="1">1</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="2" value="2">2</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="3" value="3">3</button>
          <button onClick={this.equationEquals}
                  class="red-btn" id="equals" value="equals">&#61;</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="zero" value="0">0</button>
          <button onClick={this.enterEquation}
                  class="gray-btn" id="decimal" value=".">.</button>
        </section>
      </main>
    )
  }
